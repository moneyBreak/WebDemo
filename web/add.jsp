...
<div id="wrapper">
        ...
        <div class="sidebar-scroll">
            <nav>
                <ul class="nav">
                    ...
                    <li><a href="person.html" ><i class="lnr lnr-dice"></i> <span>个人中心</span></a></li>
                </ul>
            </nav>
        </div>
    </div>
    ...
    <div class="main">
        ...
        <div class="main-content">
            <div class="container-fluid">
                <h3 class="page-title">新增事项</h3>
                <div class="row">
                    <div >
                        <!-- INPUTS -->
                        <form role="form" action="changeUserInfo" method="get">
                            <div class="panel">
                                <div class="panel-body">
                                    <label >事项名称</label>
                                    <input id="affairName" name="affairName" type="text" class="form-control" placeholder="text field">
                                    <br>
                                    <label >事项类型</label>
                                    ...
                                    <br>
                                    <label >时间</label>
                                    <input type="text" class="form-control" placeholder="今天得日期">
                                    <br>
                                    <label >状态</label>
                                    <input id="situ" name="situ" type="text" class="form-control" placeholder="新增">
                                    <br>
                                    <textarea id="content" name="content" class="form-control" placeholder="textarea" rows="4"></textarea>
                                    <br>
                                    <label >备注</label>
                                    <input type="text" class="form-control" placeholder="今天得日期">
                                    <br>
...
<script>
    function add() {
        var affairName = document.getElementById("affairName");
